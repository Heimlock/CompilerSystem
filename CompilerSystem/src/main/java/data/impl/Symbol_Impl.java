...
public class Symbol_Impl implements Symbol {
  ...
  public String toString() {
    return String.format("Symbol [line=%d, offset=%d, lexemeScope=%s, lexeme=%s, stackAddr=%d]", token.getLineIndex(), token.getLineOffset(), lexemeScope.toString(), token.getLexeme(), getStackAddr().orElse(-1));
  }
